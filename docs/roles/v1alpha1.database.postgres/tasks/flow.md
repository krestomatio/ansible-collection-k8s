...
pgbouncer.yml(pgbouncer.yml) --> resource/pgbouncer/netpol.yml(resource/pgbouncer/netpol.yml)  
...
postgres.yml(postgres.yml) --> resource/postgres/netpol.yml(resource/postgres/netpol.yml)  
